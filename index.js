...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// It can access other local functions, var, ect. to create the closure.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    const lowerCases = data.map(function(item){
  ...
  */
  ...
  function USApop(arrayCb){
    const pop = arrayCb.reduce(function(acc, item){
...
/* 🐴🐴🐴 Step 4: Create a new object that uses CuboidMaker 🐴🐴🐴
  ...
  let dimensions = {length: 4, width: 5, height: 5};
